...
that allows visualization of `NetJSON NetworkGraph <https://netjson.org/docs/what.html#networkgraph>`_ objects. The library uses SVG for visualization,
...
We need a way to retrieve a `NetJSON DeviceMonitoring <https://netjson.org/docs/what.html#devicemonitoring>`_
...
- Implement a way to retrieve a `NetJSON DeviceMonitoring <https://netjson.org/docs/what.html#devicemonitoring>`_ object via ubus
...
We want to change the library so it can return `NetJSON DeviceMonitoring <https://netjson.org/docs/what.html#devicemonitoring>`_ output.

**Measurable outcomes:**

- Change the JSON output to match `NetJSON DeviceMonitoring <https://netjson.org/docs/what.html#devicemonitoring>`_
...
We want to add `NetJSON NetworkGraph <https://netjson.org/docs/what.html#networkgraph>`_ output to
``batadv-viz``.

**Measurable outcomes:**

- Implement `NetJSON NetworkGraph <https://netjson.org/docs/what.html#networkgraph>`_ output in ``batadv-viz``
...
The configuration format format used by netjsonconfig is `NetJSON DeviceConfiguration <https://netjson.org/docs/what.html#deviceconfiguration>`_, but a *YAML*
...
- Implement an ansible module that integrates netjsonconfig in ansible and allows using
  `NetJSON DeviceConfiguration <https://netjson.org/docs/what.html#deviceconfiguration>`_ (or its *YAML* equivalent) to configure OpenWRT devices
...
`NetJSON DeviceConfiguration <https://netjson.org/docs/what.html#deviceconfiguration>`_ has been implemented only on `OpenWRT <http://openwrt.org>`_:
...
`NetJSON DeviceConfiguration <https://netjson.org/docs/what.html#deviceconfiguration>`_ has been
...
`NetJSON DeviceConfiguration <https://netjson.org/docs/what.html#deviceconfiguration>`_ object and not vice versa.
...
- Backward ``generate()`` pocess: a configuration archive must be converted to
  `NetJSON DeviceConfiguration <https://netjson.org/docs/what.html#deviceconfiguration>`_ through the available backends
